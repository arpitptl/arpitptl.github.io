  ...
  const projectData = [
    {
      title: "AwesomeTODO",
      subTitle:
        "AwesomeTODO is a simple and minimalistic todo cli application built with Golang.",
      thumbnail: "../img/projects-default.jpg",
      description:
        "AwesomeTODO cli application lets you manage your todo list with ease. You can add, delete, and view your todo list with just a few commands. It is built with GO and uses In-Memory storage for storing the todo list. User can visualize the todo list in the form of colourful table.",
      techStack: ["GO"],
      srcURL: "https://github.com/arpitptl/go-awesome-todo-cli",
    },
    {
      title: "Banking Management System",
      subTitle: "A Django-based web application designed to manage different types of accounts and banking transactions.",
      thumbnail: "../img/projects-default.jpg",
      description:
      ...
      srcURL: "https://github.com/arpitptl/banking-system",
    },
    {
      title: "ChatApp",
      subTitle:
        "A chat application built with React and Node.js that allows you to chat with your friends and family.",
      thumbnail: "../img/projects-default.jpg",
      description:
        "A chat application built with Node.js, Express, and socket.io where users can join private chat room and connect with other users. They can send/receive messages and also share their current location with other users. User can also join the private chat room and chat with other users.",
      techStack: ["Node.js", "Express", "Socket.io"],
      srcURL: "https://github.com/arpitptl/chat-app",
    },
    {
      title: "QuizApp",
      subTitle: "A quiz application built with Python and Django that allows you to create and take quizzes.",
      thumbnail: "../img/projects-default.jpg",
      description:
        "Quiz app based on Django framework, javascript, jQuery and ajax where user can register and test his/her knowledge in various topics. Admin user can manage quizzes and see the result of all the users. Admin can create quiz and also check historical results of all the users.",
      techStack: ["Python", "Django", "JavaScript", "jQuery", "Ajax"],
      srcURL: "https://github.com/arpitptl/quiz-app",
    }
  ];
  ...
  async function getRepoList() {
    try {
      const response = await fetch(
        "https://api.github.com/users/arpitptl/repos"
      );
